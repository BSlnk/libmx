...
int main(int argc, char *argv[]) {
    ...
    mx_printstr("\n\n----------------MX_NBR_TO_HEX-------------------\n");
        char *hex1 = mx_nbr_to_hex(9223372036854775807);
        char *hex2 = mx_nbr_to_hex(140732918889176);
        printf("mx_nbr_to_hex of 9223372036854775807 is 7fffffffffffffff|\n\t\t\t\t\t%s|\n", hex1);
        printf("mx_nbr_to_hex of 140732918889176 is 7ffeefa37ad8|\n\t\t\t\t    %s|\n", hex2);
    ...
    mx_printstr("\n\n----------------MX_STRNDUP-------------------\n");
        ...
        char *strndup1 = mx_strndup("", 0);
        mx_printstr("mx_strndup return \"nothing - NULL\"? | "); mx_printstr(strndup1); mx_printstr("\n");
    ...
    mx_printstr("\n----------------MX_MEMMEM-------------------\n");
        unsigned char memmem_big1[25] = "Hellololololololololo Neo";
        unsigned char memmem_little1[2] = "lo";
        size_t big_len1 = 10;
        size_t little_len1 = 2;
